...
contract GoldReserve is ERC1155, Ownable, ReentrancyGuard {
    ...
    function setMintPriceRenamed(uint256 newPrice) external onlyOwner {
        mintPrice = newPrice;
    }
